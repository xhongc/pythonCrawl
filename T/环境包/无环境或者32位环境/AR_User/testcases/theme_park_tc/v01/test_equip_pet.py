...
class EquipPetTest(unittest.TestCase):
    ...
    def test_equip_pet_success(self):
        ...
        assert_that(res_data["star"], equal_to(star+1), "response star error...")

        res = self.ar_con.get_theme_park(user_id, -1)
        res_data = json.loads(res)
        assert_that(res_data, has_key("pet_id"+str(pos)), "no pet_id1 response...")
        assert_that(res_data["pet_id"+str(pos)], equal_to(pet_id), "response pet_id1 error...")
    ...
    def test_equip_pet_already_equipped(self):
        ...
        assert_that(res_data["pet_id1"], equal_to(pet_id_2), "response pet_id1 error...")
    ...
    def test_equip_pet_without_pos(self):
        ...
        res_data = json.loads(res)
        assert_that(res_data, has_key("pet_id1"), "no pet_id1 response...")
        assert_that(res_data["pet_id1"], equal_to(pet_id), "response pet_id1 error...")
    ...
    def test_equip_pet_error_pos(self):
        ...
        assert_that(res_data["pet_id5"], equal_to(pet_id), "response pet_id1 error...")
    ...
    def test_equip_pet_from_follow_pet(self):
        ...
        assert_that(res_data["code"], equal_to(EC_PET_NOT_FREE["code"]), "response code mismatching...")
        assert_that(res_data["err_msg"], equal_to(EC_PET_NOT_FREE["err_msg"]), "response msg mismatching...")
...
if __name__ == "__main__":
    ...
    # suite.addTest(EquipPetTest("test_equip_pet_without_params"))
    #
    # # 执行测试
