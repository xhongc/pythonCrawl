...
class SetFollowPetTest(unittest.TestCase):
    ...
    def test_set_follow_pet_success(self):
        ...
        assert_that(res_data["star"], equal_to(star), "response pet_id1 error...")
    ...
    def test_set_follow_pet_from_stage_pet(self):
        ...
        res_data = json.loads(res)
        assert_that(res_data, has_key("star"), "no pet_id1 response...")
        assert_that(res_data["star"], equal_to(star+1), "response pet_id1 error...")
...
if __name__ == "__main__":
    ...
    suite.addTest(SetFollowPetTest("test_set_follow_pet_without_params"))
