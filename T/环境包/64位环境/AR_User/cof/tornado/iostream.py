...
class UnsatisfiableReadError(Exception):
    ...
    argument.
    当max_bytes超出最大字节时抛出 read 不能被满足
    """
    pass
...
class BaseIOStream(object):
    ...
    def _try_inline_read(self):
        ...
        尝试读操作 从buffered数据
        If the read can be completed without blocking, 
        如果读操作
        schedules the
        read callback on the next IOLoop iteration; 
