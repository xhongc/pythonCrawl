...
def _add_default_handler(logger):
    ...
    handler.setFormatter(logging_t.Formatter(
...
class Identified(object):
    ...
    def _should_log_debug(self):
        return self.logger.isEnabledFor(logging_t.DEBUG)

    def _should_log_info(self):
        return self.logger.isEnabledFor(logging_t.INFO)
...
class InstanceLogger(object):
    ...
    _echo_map = {
        None: logging_t.NOTSET,
        False: logging_t.NOTSET,
        True: logging_t.INFO,
        'debug': logging_t.DEBUG,
    }
    ...
    def debug(self, msg, *args, **kwargs):
        ...
        self.log(logging_t.DEBUG, msg, *args, **kwargs)

    def info(self, msg, *args, **kwargs):
        """Delegate an info call to the underlying logger."""

        self.log(logging_t.INFO, msg, *args, **kwargs)

    def warning(self, msg, *args, **kwargs):
        """Delegate a warning call to the underlying logger."""

        self.log(logging_t.WARNING, msg, *args, **kwargs)
    ...
    def error(self, msg, *args, **kwargs):
        ...
        """
        self.log(logging_t.ERROR, msg, *args, **kwargs)
    ...
    def critical(self, msg, *args, **kwargs):
        ...
        self.log(logging_t.CRITICAL, msg, *args, **kwargs)
    ...
    def log(self, level, msg, *args, **kwargs):
        ...
        if selected_level == logging_t.NOTSET:
